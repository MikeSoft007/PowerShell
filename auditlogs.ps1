Function Split-O365AuditLogs-FromO365 ()
{
	...
	[DateTime]$startDate = "05/24/2021 00:00" #Format: mm/dd/yyyy hh:MM
	[DateTime]$endDate = "06/07/2021 23:59" #Format: mm/dd/yyyy hh:MM
	$SpecifiedUserIDs = "michael@wave38.tk", "tolu@wave38.tk" #syntax: "<value1>","<value2>",..."<valueX>".
	...
	$fileName = ("C:\Users\TestLab\Desktop\" + $datestring + ".csv")
